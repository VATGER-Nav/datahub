...
[
  {
    ...
    "cpdlc_login": "EDXX",
    "s1_theory": true,
    "required_familiarisations": ["ABC+DEF", "GHI"]
  }
]
```
...
- `required_familiarisations` (optional) familiarisations required for CTR sector, when multiple are required combine them with + in same entry.
